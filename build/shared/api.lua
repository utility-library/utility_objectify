...
local server_rpc_mt, server_plugin_rpc_mt = nil  
server_rpc_mt = {
...
deepcopy = leap.registerfunc(function(orig, copies)
    copies = copies or {}
    ...
    return copy
end, {args={{name = "orig"},{name = "copies"},},name="deepcopy",has_return=true,})
